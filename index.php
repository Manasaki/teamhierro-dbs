...
<p>
    <?php
      ...
      if (!isset($_GET['playepisode']) || empty($_GET['playepisode'])) {
		...
		echo episodeCount();
		echo " episodes, and are actively adding more. The site is built for iOS devices but also is compatable with the Chromecast.<br/><br/>If you find something wrong with the site, please use the email link at the bottom of the page to report it.</p><hr/>";
          foreach ($files as $file => $value) {
			...
			} else if(($short >= 47) && ($short <= 76))			{
				echo "<p class='bg-success'><strong>Future Trunks</strong> - Episode: ".$short." <a href='index.php?playepisode=$short'>Click Here To Play</a><br /></p>";
			} else if ($short > 76){
				echo "<p class='text-justify'><strong>Universe Survival</strong> - Episode: ".$short." <a href='index.php?playepisode=$short'>Click Here To Play</a><br /></p>";
			} else {
